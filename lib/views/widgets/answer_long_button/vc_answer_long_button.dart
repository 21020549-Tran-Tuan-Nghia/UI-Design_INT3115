...
class VCAnswerLongButton extends StatefulWidget {
  ...
  @override
  State<VCAnswerLongButton> createState() => _VCSmallButtonState();
}

class _VCSmallButtonState extends State<VCAnswerLongButton> {
  bool _tapped = false;
  bool _locked = false;
